const fs = require('fs');
let content = fs.readFileSync('src/services/fallbackData.ts', 'utf8');
...
fs.writeFileSync('src/services/fallbackData.ts', content);
console.log("Images patched in fallbackData.ts");
